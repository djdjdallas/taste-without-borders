        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: `Please analyze the provided menu image. Translate the dish names into English and list the common ingredients for each dish. The response should be structured as follows:

  Dish Name: [Translated Dish Name]
  Ingredients: [List of Common Ingredients]

  Repeat this format for each dish on the menu. Ensure that the translations and ingredient lists are concise and accurate.`,
              },
              {
                type: "image_url",
                image_url: {
