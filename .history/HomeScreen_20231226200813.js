...
import { StyleSheet, View, Button, Image, Alert, Text, TouchableOpacity } from "react-native";
...
const HomeScreen = () => {
  ...
  return (
    <View style={{ marginTop: 100 }}>
      ...
      <TouchableOpacity title="Analyze Image" onPress={analyzeImage} </TouchableOpacity>
      <TouchableOpacity title="Analyze Food Image" onPress={analyzeFoodImage} </TouchableOpacity>
      {responseText ? (
