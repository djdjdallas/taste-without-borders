...
const styles = StyleSheet.create({
  ...
  responseText: {
    ...
    padding: 20,
    borderWidth: 1,
    borderColor: "#7f8c8d", // A soft grey border
    ...
    fontWeight: "600", // A bolder weight
    fontStyle: "italic", // An italic style for a distinct look
    textShadowColor: "rgba(0, 0, 0, 0.75)", // Adding a text shadow
    textShadowOffset: { width: -1, height: 1 },
    textShadowRadius: 10,
    elevation: 6, // Elevated shadow for depth
