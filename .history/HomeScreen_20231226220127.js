    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonGroup}>
        <TouchableOpacity style={styles.button} onPress={analyzeImage}>
          ...
          <Text style={styles.buttonTextGroup}>Translate Food Menu</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button} onPress={analyzeFoodImage}>
          <Image source={iconForAnalyzeFoodImage} style={styles.halfImage} />
          <Text style={styles.buttonTextGroup}>Identify</Text>
          <Text style={styles.buttonTextGroup}>Your Dish</Text>
        </TouchableOpacity>
      </View>
