  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonGroup}>
        <TouchableOpacity style={styles.halfImage} onPress={analyzeImage}>
...
const styles = StyleSheet.create({
  ...
  halfImage: {
    ...
    height: "50%", // Image takes half height of the button
    bottom: 0, // Position the image at the bottom half of the button
