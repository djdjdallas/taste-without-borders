...
const iconForAnalyzeFoodImage = {
  uri: "http://example.com/analyze-food-image-icon.png",
};
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonGroup}>
        <TouchableOpacity style={styles.button} onPress={analyzeImage}>
          <Image source={iconForAnalyzeImage} style={styles.icon} />
          <Text style={styles.buttonText}>Analyze Image</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button} onPress={analyzeFoodImage}>
          <Image source={iconForAnalyzeFoodImage} style={styles.icon} />
          <Text style={styles.buttonText}>Analyze Food Image</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  button: {
    ...
    alignItems: "center",
    width: "80%", // Assuming you want to set the width to 80% of the screen width
    alignItems: "center",
  },
  buttonText: {
    fontSize: 18,
  ...
  icon: {
    width: 100, // Set the icon size you want
    height: 100, // Set the icon size you want
